...
id = 'label_received_product_quantity'
widget = [ html.H6(' Количество принятого товара'), html.H1(style={'color': 'DarkBlue'}, id=id), ]
widget_update_data_type = 'children'
widget_select_index = 'received_product_quantity'
...
def widget_update(df, filter_values_list, n):
    ...
    return df['received_product_quantity']
