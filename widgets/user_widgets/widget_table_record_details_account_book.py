...
id = 'table_record_details_account_book'  
table_alias = 'account_book'
table_name = 'Книга учета'
widget_select_index = 'account_book'                 # id соответствующего select из database_select.py
# columns_all = ['id', 'id_0', 'f_p','name','gtdnum','date_in','time_in','date_otc','date_chk','g32','g31','g33_in','g35',
# 'g31_3', 'g31_3a', 'doc_num_out','gtdregime_out','date_out','g32_out','g33_out','g31_2_out','g35_out',
# 'g31_3_out']
сolumns_displayed = {
...
columns_all = ['id'] + list(сolumns_displayed.keys())
...
def widget_update(df, filter_values_list, n):
    ...
    # print('filter_values_list', filter_values_list)
    ...
    # if filter_values_list[1][0] or filter_values_list[1][1]:
    #     print(11111111)
    #     if filter_values_list[1][0]:
    #         df_table = df_table[ df_table['date_in'] >= filter_values_list[1][0] ]
    #     if filter_values_list[1][1]:
    #         df_table = df_table[ df_table['date_in'] < filter_values_list[1][1] ]     
