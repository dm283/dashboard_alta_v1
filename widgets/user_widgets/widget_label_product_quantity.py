...
id = 'label_product_quantity'
widget = [ html.H6('Количество товара на складе'), html.H1(style={'color': 'DarkBlue'}, id=id), ]
widget_update_data_type = 'children'
widget_select_index = 'product_quantity'
